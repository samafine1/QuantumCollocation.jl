export UnitaryMaxToggleProblem


@doc raw"""
    UnitaryMaxToggleProblem(
...
"""
function UnitaryMaxToggleProblem end
...
function UnitaryMaxToggleProblem(
    ...
    if piccolo_options.verbose
        println("    constructing UnitaryMaxToggleProblem...")
        println("\tfinal fidelity: $(final_fidelity)")
...
@testitem "Maximum Toggle Hadamard gate" begin
    ...
    min_prob = UnitaryMaxToggleProblem(
        prob, U_goal,
        piccolo_options=PiccoloOptions(verbose=false)
    )
