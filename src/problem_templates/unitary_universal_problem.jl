export UnitaryUniversalProblem


@doc raw"""
    UnitaryUniversalProblem(system::AbstractQuantumSystem, operator::AbstractPiccoloOperator, T::Int, Δt::Float64; kwargs...)
    UnitaryUniversalProblem(H_drift, H_drives, operator, T, Δt; kwargs...)
...
"""
function UnitaryUniversalProblem end

function UnitaryUniversalProblem(
    ...
    activate_lightspeed::Bool=false,
    ...
    if piccolo_options.verbose
        println("    constructing UnitaryUniversalProblem...")
    ...
    elseif activate_lightspeed
        J += UltraUniversalObjective(traj; basis=basis, Qu=Qu, Qb=Qb, toggle=toggle)
    else
...
function UnitaryUniversalProblem(
    ...
    return UnitaryUniversalProblem(system, args...; kwargs...)
end
